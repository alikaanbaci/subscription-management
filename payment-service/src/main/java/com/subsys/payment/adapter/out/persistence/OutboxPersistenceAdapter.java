...
import com.subsys.payment.adapter.out.persistence.mapper.OutboxPersistenceMapper;
import com.subsys.payment.adapter.out.persistence.repository.OutboxEventJpaRepository;
...
public class OutboxPersistenceAdapter implements OutboxReadOutPort, OutboxWriteOutPort {
    ...
    @Override
    public void paymentCompleted(UUID aggregateId, String eventKey, Object payload) {
        try {
            save(OutboxEvent.paymentCompleted(aggregateId, eventKey, objectMapper.writeValueAsString(payload)));
