package com.subsys.notification.config;
...
public class KafkaConsumerConfig {
    ...
    public DefaultErrorHandler commonErrorHandler() {
        ...
        errorHandler.setRetryListeners((record, exception, deliveryAttempt) ->
                log.warn("notification_consumer_retry topic={} partition={} offset={} attempt={}",
    ...
    private String resolveDlqTopic(ConsumerRecord<?, ?> record) {
        return switch (record.topic()) {
            case TopicNames.PAYMENT_COMPLETED -> TopicNames.PAYMENT_COMPLETED_DLQ;
            case TopicNames.SUBSCRIPTION_STATUS_CHANGED -> TopicNames.SUBSCRIPTION_STATUS_CHANGED_DLQ;
